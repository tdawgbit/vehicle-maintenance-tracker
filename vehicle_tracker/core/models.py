...
class Vehicle(models.Model):
    ...
    type = models.ForeignKey(VehicleType, on_delete=models.PROTECT, db_column="type_id", related_name="vehicles")
...
class MaintenanceLog(models.Model):
    vehicle = models.ForeignKey(Vehicle, on_delete=models.CASCADE, db_column="vehicle_id", related_name="maintenance_logs")
...
class LogService(models.Model):
    log = models.ForeignKey(MaintenanceLog, on_delete=models.CASCADE, db_column="log_id", related_name="log_services")
    service_type = models.ForeignKey(ServiceType, on_delete=models.PROTECT, db_column="service_type_id", related_name="log_services")
